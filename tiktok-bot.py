...
print("1. Tiktok-Bot")
print("2. Instagram-Bot")
print("3. Twitter / X")
print("4. Facebook")
print("5. YouTube")
print("6. Telegram")

Options = int(input("Choose one app:"))
...
if Options == 1:
    ...
    services = data.get('data', {}).get('instagram', {}).get('services', [])
    for i, service in enumerate(services, 1):
        sid = service.get('id')
        name = names.get(sid, service.get('name', '').strip())
        rate = service.get('description', '').strip()
